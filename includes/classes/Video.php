    ...
    public function incrementViews() {
        ...
        public function getDislikes() {
            ...
            public function isBookmarked() {
                $query=$this->con->prepare("SELECT * FROM bookmarks WHERE username=:username and videoId=:videoId");
                $query->bindParam(":username", $username);
                $query->bindParam(":videoId", $id);
                $id=$this->getId();
                $username=$this->userLoggedInObj->getUsername();
            ...
            public function removeBookmark() {
                $id=$this->getId();
                $username=$this->userLoggedInObj->getUsername();
                $query=$this->con->prepare("DELETE FROM bookmarks WHERE username=:username and videoId=:videoId");
                $query->bindParam(":username", $username);
                $query->bindParam(":videoId", $id);
                $query->execute();
            }
            ...
            public function bookmark() {
                $id=$this->getId();
                $username=$this->userLoggedInObj->getUsername();
                $query=$this->con->prepare("INSERT INTO bookmarks(username, videoId) VALUES(:username, :videoId)");
                $query->bindParam(":username", $username);
                $query->bindParam(":videoId", $id);
                $query->execute();
            }
