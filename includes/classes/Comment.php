...
require_once("CommentResponseSection.php");
class  Comment{
    ...
    public function formComment() {
        ...
        $channelButton = ButtonHtmlGenerator::createChannelButton($this->con, $postedBy);
        $timespan=$this->time_elapsed_string($this->sqlData["datePosted"]);

        $commentResponseObj=new CommentResponseSection($this->con, $this, $this->userLoggedInObj);
        $commentResponses=$commentResponseObj->create();
