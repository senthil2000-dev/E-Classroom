function postQuery(button, postedBy, videoId, answerTo, containerClass) {
    var textarea=$(button).siblings("textarea");
    var commentText=textarea.val();
    textarea.val("");
    var str=$(".commentCount").text();
    
    var res = str.replace(" Chats in forum", "");
    var n=Number(res)+1;
    $(".commentCount").text(n+" Chats in forum");
    if(commentText) {

        $.post("ajax/postQuery.php", { commentText:commentText, postedBy:postedBy, videoId:videoId, responseTo: answerTo})
